        ...
        <div class="col-md-8">
            <div class="portlet light portlet-fit portlet-form ">
                <div class="portlet-title">
                    <div class="caption font-red">
                        <i class="icon-layers font-red"></i>
                        <span class="caption-subject bold">&nbsp;รายงานความก้าวหน้าครั้งที่ 2</span>
                    </div>
                </div>
                <div class="portlet-body">
                    <!-- BEGIN FORM-->
                                ...
                                <div class="col-md-5">
                                    {!!
                                        $upload ?
                                            ...
                                            ? '<input type="file" class="form-control" name="file_10"/><span class="help-block">' . trans("fund.form_user_request-old_file") . ' ' . '<a href="'. route('base') . '/' . $upload[0]->file_path . '" download  title="ดาวน์โหลดเอกสาร"><span aria-hidden="true" class="icon-arrow-down"></span></a></span>'
                                            : $upload[0]->html
                                ...
                                <div class="col-md-5">
                                    {!!
                                        $upload ?
                                            ...
                                            ? '<input type="file" class="form-control" name="file_11"/><span class="help-block">' . trans("fund.form_user_request-old_file") . ' ' . '<a href="'. route('base') . '/' . $upload[1]->file_path . '" download  title="ดาวน์โหลดเอกสาร"><span aria-hidden="true" class="icon-arrow-down"></span></a></span>'
                                            : $upload[1]->html
