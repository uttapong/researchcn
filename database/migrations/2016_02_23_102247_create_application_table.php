...
class CreateApplicationTable extends Migration
{
    ...
    public function up()
    {
      ...
      Schema::create('applications', function (Blueprint $table) {
          ...
          /*
            applied(สมัครทุนแล้ว), approved(อนุมัติสมัครทุน), rejected(ไม่อนุมัติสมัครทุน)
            ...
            second_payment(เบิกเงินงวดที่ 2 อันนี้จะรวมกับรายงานความก้าวหน้าครั้งที่ 1), approved_second_payment(อนุมัติเบิกเงินงวดที่ 2), rejected_second_payment(ไม่อนุมัติเบิกเงินงวดที่ 2)
